...
a_interp = griddedInterpolant(z_p,a,'pchip','nearest');
a_interp = a_interp(z_t);
phi_interp = griddedInterpolant(z_p,phi,'pchip','nearest');
...
dudr_interp = griddedInterpolant(z_u,dudr,'pchip','nearest');
dudr_interp = dudr_interp(z_t);
d2udrdt_interp = griddedInterpolant(z_u,d2udrdt,'pchip','nearest');
...
%%%%%%%%%%%%% Spherical %%%%%%%%%%%%%%%%%
function [P,u] = Spherical_old_pde(P1,u1,P2,u2,P0,rho,drhodt,...
            phi,a,SurfTens,eta,beta,dbetadt,R,g,z_p,z_u,dt1,dt2,BC,timescheme)
